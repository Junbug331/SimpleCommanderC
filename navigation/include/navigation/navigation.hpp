...
public:
    ...
    bool NavigateThroughPoses(const std::vector<geometry_msgs::msg::PoseStamped> &);
...
private:
    ...
    std::shared_future<rclcpp_action::ClientGoalHandle<nav2_msgs::action::NavigateThroughPoses>::WrappedResult> future_navigate_through_poses;
